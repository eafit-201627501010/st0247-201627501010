...
public class Test {
	...
	public static void main(String[] args) {
		...
		DigraphMA gMatrix = new DigraphMA(SIZE);
		fillGraph(gMatrix);
	...
	static boolean testDFS(DigraphAL gList, DigraphMA gMatrix) {
	...
	static boolean testBFS(DigraphAL gList, DigraphMA gMatrix) {
	...
	static boolean testHayCaminoDFS(DigraphAL gList, DigraphMA gMatrix) {
		boolean tmp;
	...
	static boolean testHayCaminoBFS(DigraphAL gList, DigraphMA gMatrix) {
		boolean tmp;
